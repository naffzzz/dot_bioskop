...
namespace dot_bioskop.Controllers
{
    ...
    public class MovieTagsController : ControllerBase
    {
        ...
        public IActionResult GetMovieTag(int id)
        {
            ...
            if (movie != null)
            {
                _logger.LogInformation("Log accessing available specified movie tags data");
                return Ok(movie);
            }
            else
            {
                _logger.LogInformation("Log accessing unavailable specified movie tags data");
        ...
        public IActionResult DeleteMovieTag(int id)
        {
            ...
            if (movie_tag != null)
            {
                _logger.LogInformation("Log deleting available specified movie tags data");
                _movieTagsData.DeleteMovieTag(movie_tag);
                return Ok("Tag Movie berhasil dihapus");
            }
            else
            {
                _logger.LogInformation("Log deleting unavailable specified movie tags data");
                return NotFound("Tag Movie tidak diketemukan");
            }
        }
        ...
        public IActionResult UpdateMovieTag(int id, movie_tags movie_tag)
        {
            ...
            {
                _logger.LogInformation("Log updating available specified movie tags data");
            ...
            {
                _logger.LogInformation("Log updating unavailable specified movie tags data");
                return NotFound("Tag Movie tidak diketemukan");
            }
        }
    }
